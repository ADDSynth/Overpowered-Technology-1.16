...
public final class GuiGemConverter extends GuiEnergyBase<TileGemConverter, ContainerGemConverter> {
  ...
  public final void init(){
    super.init();
    addButton(new CycleGemButton(this.leftPos + left_button_x, this.topPos + cycle_button_y,false, tile));
    addButton(new CycleGemButton(this.leftPos + right_button_x, this.topPos + cycle_button_y,true, tile));
  }
