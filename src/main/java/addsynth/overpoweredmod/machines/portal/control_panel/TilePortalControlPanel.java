  ...
  public final void generate_portal(){
    if(valid_portal){
      ...
      case X:
        ...
        WorldUtil.spawnItemStack(level, center, start_y, start_z, new ItemStack(OverpoweredItems.void_crystal, 1), false);
        break;
      case Z:
        ...
        WorldUtil.spawnItemStack(level, start_x, start_y, center, new ItemStack(OverpoweredItems.void_crystal, 1), false);
        break;
      }
