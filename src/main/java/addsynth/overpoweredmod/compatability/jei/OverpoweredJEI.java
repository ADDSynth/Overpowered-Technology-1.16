...
// https://github.com/micdoodle8/Galacticraft/blob/MC1.10/src/main/java/micdoodle8/mods/galacticraft/core/client/jei/GalacticraftJEI.java#L90
  ...
  private static final void add_information(IRecipeRegistration registry){
    ...
    // Beam Items
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.scanning_laser),            VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.scanning_laser"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.destructive_laser),         VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.destructive_laser"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.energy_stabilizer),         VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.energy_stabilizer"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.heavy_light_emitter),       VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.heavy_light_emitter"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.matter_energy_transformer), VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.matter_energy_transformer"));

    // Items
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.plasma),                  VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.plasma"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.matter_energy_converter), VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.matter_energy_converter"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.vacuum_container),        VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.vacuum_container"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.reinforced_container),    VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.reinforced_container"));
    registry.addIngredientInfo(new ItemStack(OverpoweredItems.unimatter),               VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.unimatter"));
    ...
    registry.addIngredientInfo(new ItemStack(OverpoweredBlocks.plasma_generator),         VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.plasma_generator"));
    registry.addIngredientInfo(new ItemStack(OverpoweredBlocks.matter_compressor),        VanillaTypes.ITEM, new TranslationTextComponent("gui.overpowered.jei_description.matter_compressor"));
