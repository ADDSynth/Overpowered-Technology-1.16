...
public enum OverpoweredTiers implements IItemTier {
  CELESTIAL        (4, ItemTier.DIAMOND.getUses()*3, 12.0f, 4.0f, 0, Ingredient.of(Init.celestial_gem)),
  CELESTIAL_PICKAXE(4, ItemTier.DIAMOND.getUses()*3, 16.0f, 4.0f, 0, Ingredient.of(Init.celestial_gem)),
  CELESTIAL_SWORD  (4, 1000,                         12.0f, 4.0f, 0, Ingredient.of(Init.celestial_gem)),
  VOID             (4, ItemTier.DIAMOND.getUses()*5, 12.0f, 5.0f, 0, Ingredient.of(Init.void_crystal));
