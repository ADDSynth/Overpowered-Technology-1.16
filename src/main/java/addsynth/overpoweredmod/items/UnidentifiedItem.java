...
public final class UnidentifiedItem extends OverpoweredItem {
  ...
  public UnidentifiedItem(final int ring_id){
    super(Names.UNIDENTIFIED_RING[ring_id], CreativeTabs.tools_creative_tab);
  ...
  public UnidentifiedItem(@Nonnull final ArmorMaterial material, @Nonnull final EquipmentType type){
    super(new ResourceLocation(OverpoweredTechnology.MOD_ID, "unidentified_"+material.name+"_"+type.name), CreativeTabs.tools_creative_tab);
    this.ring_id = -1;
