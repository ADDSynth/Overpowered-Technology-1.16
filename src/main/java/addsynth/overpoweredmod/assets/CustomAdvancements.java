...
public final class CustomAdvancements {
  ...
  public static final ResourceLocation FIRE_LASER =
    new ResourceLocation(OverpoweredTechnology.MOD_ID, "overpowered/fire_laser");
  ...
  public static final ResourceLocation IDENTIFY_SOMETHING =
    new ResourceLocation(OverpoweredTechnology.MOD_ID, "overpowered/identify_something");

  public static final ResourceLocation CONVERT_A_THOUSAND_GEMS =
    new ResourceLocation(OverpoweredTechnology.MOD_ID, "overpowered/convert_a_thousand_gems");

  public static final ResourceLocation FUSION_ENERGY =
    new ResourceLocation(OverpoweredTechnology.MOD_ID, "overpowered/fusion_energy");
