...
// https://github.com/Vazkii/Botania/blob/master/src/main/java/vazkii/botania/common/core/loot/LootHandler.java
  ...
  */
  ...
  private static final LootPool build_loot_pool(){
    ...
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.LEATHER.ordinal()][0]).setWeight(leather_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.LEATHER.ordinal()][1]).setWeight(leather_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.LEATHER.ordinal()][2]).setWeight(leather_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.LEATHER.ordinal()][3]).setWeight(leather_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.GOLD.ordinal()][0]).setWeight(gold_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.GOLD.ordinal()][1]).setWeight(gold_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.GOLD.ordinal()][2]).setWeight(gold_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.GOLD.ordinal()][3]).setWeight(gold_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.CHAINMAIL.ordinal()][0]).setWeight(chainmail_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.CHAINMAIL.ordinal()][1]).setWeight(chainmail_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.CHAINMAIL.ordinal()][2]).setWeight(chainmail_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.CHAINMAIL.ordinal()][3]).setWeight(chainmail_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.IRON.ordinal()][0]).setWeight(iron_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.IRON.ordinal()][1]).setWeight(iron_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.IRON.ordinal()][2]).setWeight(iron_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.IRON.ordinal()][3]).setWeight(iron_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.DIAMOND.ordinal()][0]).setWeight(diamond_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.DIAMOND.ordinal()][1]).setWeight(diamond_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.DIAMOND.ordinal()][2]).setWeight(diamond_weight));
    loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.unidentified_armor[ArmorMaterial.DIAMOND.ordinal()][3]).setWeight(diamond_weight));
    if(CompatabilityManager.are_rings_enabled()){
      loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.ring_0).setWeight(ring_weight));
      loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.ring_1).setWeight(ring_weight));
      loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.ring_2).setWeight(ring_weight));
      loot.add(ItemLootEntry.lootTableItem(OverpoweredItems.ring_3).setWeight(ring_weight));
    }
    loot.when(KilledByPlayer.killedByPlayer());
    loot.when(RandomChance.randomChance(spawn_chance));
