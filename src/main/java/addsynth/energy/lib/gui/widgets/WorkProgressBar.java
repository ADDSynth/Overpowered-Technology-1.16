...
public final class WorkProgressBar extends ProgressBar {
  ...
  public final void draw(MatrixStack matrix, ContainerScreen gui, TileAbstractWorkMachine tile){
    work_time = tile.getWorkTimePercentage();
    super.draw(matrix, gui, Direction.LEFT_TO_RIGHT, work_time, RoundMode.Floor);
  }

  public final void draw(MatrixStack matrix, ContainerScreen gui, Direction direction, TileAbstractWorkMachine tile){
    work_time = tile.getWorkTimePercentage();
