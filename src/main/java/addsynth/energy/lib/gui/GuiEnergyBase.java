...
public abstract class GuiEnergyBase<T extends TileEntity & IEnergyUser, C extends TileEntityContainer<T>> extends GuiContainerBase<C> {
  ...
  protected final void draw_energy_below_switch(final MatrixStack matrix){
  ...
  protected final void draw_energy_extraction(final MatrixStack matrix, final int draw_y){
  ...
  protected final void draw_status(MatrixStack matrix, final String status, final int x, final int y){
    GuiUtil.draw_text_left(matrix, status_text+": "+status, x, y);
  }

  protected final void draw_status_after_switch(MatrixStack matrix, final String status){
  ...
  protected final void draw_time_left_center(MatrixStack matrix, final int draw_y){
  ...
  protected final void draw_energy_difference_center(MatrixStack matrix, final int draw_y){
    final int draw_x = imageWidth/2;
    if(energy == null){
