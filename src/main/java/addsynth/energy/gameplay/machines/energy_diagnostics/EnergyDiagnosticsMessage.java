...
public final class EnergyDiagnosticsMessage {
  ...
  private EnergyDiagnosticsMessage(PacketBuffer buf){
  ...
  public static final void encode(final EnergyDiagnosticsMessage message, final PacketBuffer buf){
  ...
  public static final EnergyDiagnosticsMessage decode(final PacketBuffer buf){
  ...
  public static void handle(final EnergyDiagnosticsMessage message, final Supplier<NetworkEvent.Context> context_supplier){
    ...
    context.enqueueWork(() -> {
      ...
      final World world = minecraft.player.level;
