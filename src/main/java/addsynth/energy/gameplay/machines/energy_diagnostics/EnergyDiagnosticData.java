...
public final class EnergyDiagnosticData implements Comparable<EnergyDiagnosticData> {
  ...
  public EnergyDiagnosticData(final PacketBuffer data){
    name = data.readUtf();
  ...
  public final void set(final TileEntity tile, final Energy energy){
  ...
  public final void save(final PacketBuffer data){
    data.writeUtf(name);
