...
public class ADDSynthEnergy {
  ...
  public static final String VERSION_DATE = "October 30, 2022";
  public static final DevStage DEV_STAGE = DevStage.BETA;
  ...
  private static final void register_guis(){
    ScreenManager.register(Containers.GENERATOR,                  GuiGenerator::new);
    ScreenManager.register(Containers.ENERGY_STORAGE_CONTAINER,   GuiEnergyStorageContainer::new);
    ScreenManager.register(Containers.COMPRESSOR,                 GuiCompressor::new);
    ScreenManager.register(Containers.ELECTRIC_FURNACE,           GuiElectricFurnace::new);
    ScreenManager.register(Containers.CIRCUIT_FABRICATOR,         CircuitFabricatorGui::new);
    ScreenManager.register(Containers.UNIVERSAL_ENERGY_INTERFACE, GuiUniversalEnergyInterface::new);
  }

  private static final void set_block_render_types(){
    RenderTypeLookup.setRenderLayer(EnergyBlocks.energy_storage, RenderType.translucent());
  }
