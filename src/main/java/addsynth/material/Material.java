...
public final class Material {
  ...
  // gems
  public static final Gem AMETHYST    = new Gem("amethyst",    MaterialColor.COLOR_MAGENTA, 3, 7);
  public static final Gem AMBER       = new Gem("amber",       MaterialColor.COLOR_ORANGE,  3, 7);
  public static final Gem CITRINE     = new Gem("citrine",     MaterialColor.COLOR_YELLOW,  3, 7);
  ...
  public static final Gem RUBY        = new Gem("ruby",        MaterialColor.FIRE,          3, 7);
  public static final Gem SAPPHIRE    = new Gem("sapphire",    MaterialColor.WATER,         3, 7);
  public static final Gem TANZANITE   = new Gem("tanzanite",   MaterialColor.COLOR_PURPLE,  3, 7);
  public static final Gem TOPAZ       = new Gem("topaz",       MaterialColor.COLOR_ORANGE,  3, 7);
  public static final Gem ROSE_QUARTZ = new Gem("rose_quartz", MaterialColor.COLOR_PINK,    3, 7);
