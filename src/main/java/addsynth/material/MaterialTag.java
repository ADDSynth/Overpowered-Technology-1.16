...
public final class MaterialTag {
  ...
  public static class COPPER {
    public static final ResourceLocation   ORES = new ResourceLocation("forge:ores/copper");
    public static final ResourceLocation INGOTS = new ResourceLocation("forge:ingots/copper");
    public static final ResourceLocation BLOCKS = new ResourceLocation("forge:storage_blocks/copper");
  }
