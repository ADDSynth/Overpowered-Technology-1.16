...
public final class TeamData {
  ...
  public static final void sync(){
    ...
    if(server != null){
      ...
      // DisplaySlots
      ScoreObjective o = scoreboard.getDisplayObjective(0);
  ...
  public static final int getStandardCriteriaIndex(final String criteria){
    ...
    if(criteria.equals(ScoreCriteria.KILL_COUNT_PLAYERS.getName())){ return  3; }
    if(criteria.equals(ScoreCriteria.KILL_COUNT_ALL.getName())){     return  4; }
    if(criteria.equals(ScoreCriteria.HEALTH.getName())){             return  5; }
    if(criteria.equals(ScoreCriteria.EXPERIENCE.getName())){         return  6; }
  ...
  public static final int getStandardCriteriaIndex(final ScoreCriteria input_criteria){
    ...
    if(input_criteria == ScoreCriteria.KILL_COUNT_PLAYERS){ return  3; }
    if(input_criteria == ScoreCriteria.KILL_COUNT_ALL){     return  4; }
    if(input_criteria == ScoreCriteria.HEALTH){             return  5; }
    if(input_criteria == ScoreCriteria.EXPERIENCE){         return  6; }
  ...
  public static final String getStandardCriteria(final int index){
    ...
    case 3: criteria = ScoreCriteria.KILL_COUNT_PLAYERS; break;
    case 4: criteria = ScoreCriteria.KILL_COUNT_ALL; break;
    case 5: criteria = ScoreCriteria.HEALTH; break;
    case 6: criteria = ScoreCriteria.EXPERIENCE; break;
  ...
  public static final ScoreCriteria getCriteria(final String id){
    final Optional<ScoreCriteria> criteria = ScoreCriteria.byName(id);
