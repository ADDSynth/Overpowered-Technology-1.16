...
public final class CriteriaData {
  ...
  public static final String[] getColors(){
    ...
    return new String[] {
      TextFormatting.getById(0).getName(),
      TextFormatting.getById(1).getName(),
      TextFormatting.getById(2).getName(),
      TextFormatting.getById(3).getName(),
      TextFormatting.getById(4).getName(),
      TextFormatting.getById(5).getName(),
      TextFormatting.getById(6).getName(),
      TextFormatting.getById(7).getName(),
      TextFormatting.getById(8).getName(),
      TextFormatting.getById(9).getName(),
      TextFormatting.getById(10).getName(),
      TextFormatting.getById(11).getName(),
      TextFormatting.getById(12).getName(),
      TextFormatting.getById(13).getName(),
      TextFormatting.getById(14).getName(),
      TextFormatting.getById(15).getName(),
    };
  }
