...
public final class TeamManagerGui extends GuiBase {
  ...
  private final BiConsumer<String, Integer> onTeamSelected = (String value, Integer id) -> {
    team_selected = TextFormatting.stripFormatting(value);
    updateTeamPlayerList();
  };
  private final BiConsumer<String, Integer> onPlayerSelected = (String value, Integer id) -> {
    if(value != null){
      player_selected = TextFormatting.stripFormatting(value);
  ...
  private static final BiConsumer<String, Integer> onObjectiveSelected = (String value, Integer id) -> {
    objective_selected = TextFormatting.stripFormatting(value);
  };
  ...
  public TeamManagerGui(){
    super(442, 326, new TranslationTextComponent(Core.team_manager.getDescriptionId()), GuiReference.team_manager);
    // team_selected = null;
  ...
  public final void init(){
    ...
    // Score Controls
    new_score = new TextFieldWidget(this.font, x_position_2 + text_box_x_adjust, guiUtil.guiTop + text_box_y, text_box_width, text_box_height, new StringTextComponent("0"));
  ...
  @Override
  protected final void drawGuiBackgroundLayer(MatrixStack matrix, float partialTicks, int mouseX, int mouseY){
    guiUtil.draw_custom_background_texture(matrix, 512, 384);
  }

  @Override
  protected final void drawGuiForegroundLayer(MatrixStack matrix, final int mouseX, final int mouseY){
