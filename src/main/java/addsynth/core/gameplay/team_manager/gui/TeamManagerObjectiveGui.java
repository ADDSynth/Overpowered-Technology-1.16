...
public final class TeamManagerObjectiveGui extends GuiBase {
  ...
  protected void init(){
    ...
    // Name TextBoxes
    objective_id_name = new TextFieldWidget(this.font, left_section.x, left_section.y, left_section_width, text_box_height, new StringTextComponent(""));
    this.children.add(objective_id_name);
    objective_display_name = new TextFieldWidget(this.font, left_section.x, widget_line_2, left_section_width, text_box_height, new StringTextComponent(""));
