...
public final class TeamManagerTeamEditGui extends GuiBase {
  ...
  public TeamManagerTeamEditGui(final boolean new_team){
    super(274, 244, new TranslationTextComponent("gui.addsynthcore.team_manager.team_edit.gui_title"), GuiReference.edit_team_gui);
  ...
  public final void init(){
    ...
    team_id_name           = new TextFieldWidget(this.font,  left_x, widget_line_1, left_text_box_width, text_box_height, new StringTextComponent(""));
    team_display_name      = new TextFieldWidget(this.font, right_x, widget_line_1, right_text_box_width, text_box_height, new StringTextComponent(""));
    ...
    member_prefix          = new TextFieldWidget(this.font,  left_x, widget_line_4, left_text_box_width, text_box_height, new StringTextComponent(""));
    member_suffix          = new TextFieldWidget(this.font, right_x, widget_line_4, right_text_box_width, text_box_height, new StringTextComponent(""));
  ...
  @Override
  public final void render(MatrixStack matrix, final int mouse_x, final int mouse_y, final float partialTicks){
  ...
  @Override
  protected void drawGuiForegroundLayer(MatrixStack matrix, int mouseX, int mouseY){
