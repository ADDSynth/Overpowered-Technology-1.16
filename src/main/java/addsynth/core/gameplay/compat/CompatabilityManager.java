...
public final class CompatabilityManager {
   ...
   *  @deprecated PRIORITY All versions. Use the Set&lt;Block&gt; field in the Scythe Tool class, that is exactly how vanilla defines blocks.
   */
  @Deprecated
  public static final void set_scythe_harvest_blocks(){
    final Set<Block> leaves = new HashSet<Block>(BlockTags.LEAVES.getValues());
