...
public final class LightningStormCommand {
  ...
  private static final int lightning(final CommandSource command_source, final int strikes, final int radius, final int delay, final float chance) throws CommandSyntaxException {
    ...
    lightning_count   = 0;
    do_lightning      = true;
    command_source.sendSuccess(new TranslationTextComponent("commands.addsynthcore.lightning_storm.success", strikes, radius, delay, chance), true);
    return strikes;
  }
  ...
  private static final int stop_lightning(final CommandSource source){
    do_lightning = false;
    source.sendSuccess(new TranslationTextComponent("commands.addsynthcore.lightning_storm.stop"), false);
    return 0;
  }
  ...
  private static final int query_lightning(final CommandSource source){
    ...
    source.sendSuccess(new TranslationTextComponent("commands.addsynthcore.lightning_storm.query.false"), false);
    return 0;
  }
