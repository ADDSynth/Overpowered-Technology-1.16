...
public final class ItemExplosionCommand {
  ...
  private static final int item_explosion(final CommandSource command_source, final int item_count, final int radius) throws CommandSyntaxException {
    ...
    final Vector3d position    = command_source.getPosition();
    @SuppressWarnings("resource")
    final ServerWorld world = command_source.getLevel();
    ...
    command_source.sendSuccess(new TranslationTextComponent("commands.addsynthcore.item_explosion.success", item_count), true);
