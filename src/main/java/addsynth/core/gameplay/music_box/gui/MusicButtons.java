...
public final class MusicButtons {
  ...
  public static final class NextDirectionButton extends AdjustableButton {
    ...
    public void renderButton(MatrixStack matrix, int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_){
      setMessage(new StringTextComponent(face[tile.get_next_direction()])); // stays up-to-date MAYBE need to simplify this now, should not create things every frame
  ...
  public static final class MuteButton extends AbstractButton {
    ...
    public MuteButton(final int x, final int y, final byte track, final TileMusicBox tile){
      super(x, y, button_size, button_size, new StringTextComponent(""));
      this.tile = tile;
      this.track = track;
    }
  ...
  public static final class TrackInstrumentButton extends AbstractButton {
    ...
    @Override
    public final void renderButton(MatrixStack matrix, final int mouse_x, final int mouse_y, final float partial_ticks){
      ...
      Minecraft.getInstance().getTextureManager().bind(GuiReference.instruments);
  ...
  public static final class SwapTrackButton extends AbstractButton {
    ...
    public SwapTrackButton(final int x, final int y, final TileMusicBox tile, final int track){
      super(x, y, button_width, button_height, new StringTextComponent(""));
      this.tile = tile;
      this.track = track;
    }
