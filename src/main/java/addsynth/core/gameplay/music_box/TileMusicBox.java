...
// ================================ MAIN FUNCTIONS ===================================
  ...
  @Override
  public final void load(BlockState blockstate, CompoundNBT nbt){
  ...
  private final void play_next(){
    final TileEntity tile = level.getBlockEntity(worldPosition.relative(Direction.from3DDataValue(next_direction)));
