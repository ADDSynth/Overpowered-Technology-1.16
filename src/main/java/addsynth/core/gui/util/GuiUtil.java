...
public final class GuiUtil {
  ...
  public static final FontRenderer   font           = minecraft.font;
  ...
  public GuiUtil(final ResourceLocation gui_texture, final int gui_width, final int gui_height){
    ...
    guiLeft     = (minecraft.getWindow().getGuiScaledWidth()  - gui_width)  / 2;
    guiTop      = (minecraft.getWindow().getGuiScaledHeight() - gui_height) / 2;
...
// ========================================================================================================
  ...
  public void draw_background_texture(MatrixStack matrix){
    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
    textureManager.bind(GUI_TEXTURE);
    AbstractGui.blit(matrix, guiLeft, guiTop, guiWidth, guiHeight, 0, 0, guiWidth, guiHeight, 256, 256);
  }
   ...
   */
  public void draw_custom_background_texture(MatrixStack matrix, final int texture_width, int texture_height){
    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
    textureManager.bind(GUI_TEXTURE);
    AbstractGui.blit(matrix, guiLeft, guiTop, guiWidth, guiHeight, 0, 0, guiWidth, guiHeight, texture_width, texture_height);
  }
  ...
  public void draw(MatrixStack matrix, final int x, final int y, final int u, final int v, final int width, final int height){
    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
    textureManager.bind(GUI_TEXTURE);
    AbstractGui.blit(matrix, guiLeft + x, guiTop + y, width, height, u, v, width, height, 256, 256);
  }

  /** Draws another part of the gui texture at the coordinates you specify.
   *  If you need more control over how it's drawn, you might as well use the
   *  vanilla blit() function. */
  public void draw(MatrixStack matrix, int x, int y, int u, int v, int width, int height, int texture_width, int texture_height){
    RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f);
    textureManager.bind(GUI_TEXTURE);
    AbstractGui.blit(matrix, guiLeft + x, guiTop + y, width, height, u, v, texture_width, texture_height, 256, 256);
  }
   ...
   */
  @Deprecated
  public void draw_transparent(MatrixStack matrix, int x, int y, int u, int v, int width, int height, float opacity){
    draw_transparent(matrix, x, y, u, v, width, height, width, height, opacity);
  }
   ...
   */
  @Deprecated
  public void draw_transparent(MatrixStack matrix, int x, int y, int u, int v, int width, int height, int texture_width, int texture_height, float opacity){
    RenderSystem.color4f(1.0f, 1.0f, 1.0f, opacity);
    textureManager.bind(GUI_TEXTURE);
    AbstractGui.blit(matrix, x, y, width, height, u, v, texture_width, texture_height, 256, 256);
  }

// ========================================================================================================
  
  public final void draw_title(MatrixStack matrix, final ITextComponent title){
    draw_text_center(matrix, title.getString(), center_x, 6);
  }
  ...
  public static final void draw_text_left(MatrixStack matrix, final String text, final int x, final int y){
    font.draw(matrix, text, x, y, text_color);
  }

  /** Draws center-aligned text at the center of the gui.<br />
   *  This will render the string in a different color if you prefix the string with
   *  <code>TextFormatting.COLOR.toString()</code>. */
  public final void draw_text_center(MatrixStack matrix, final String text, final int y){
    font.draw(matrix, text, center_x - (font.width(text) / 2), y, text_color);
  }
   ...
   * @param y
   */
  public final static void draw_text_center(MatrixStack matrix, final String text, final int x, final int y){
    font.draw(matrix, text, x - (font.width(text) / 2), y, text_color);
  }

  /** Draws along the right-edge of the gui.<br />
   *  This will render the string in a different color if you prefix the string with
   *  <code>TextFormatting.COLOR.toString()</code>. */
  public final void draw_text_right(MatrixStack matrix, final String text, final int y){
    font.draw(matrix, text, right_edge - font.width(text), y, text_color);
  }

  /** This will render the string in a different color if you prefix the string with
   *  <code>TextFormatting.COLOR.toString()</code>. */
  public static final void draw_text_right(MatrixStack matrix, final String text, final int x, final int y){
    font.draw(matrix, text, x - font.width(text), y, text_color);
  }
...
// ========================================================================================================
  ...
  public static final void drawItemTooltip(MatrixStack matrix, Screen screen, ItemStack itemStack, int x, int y, int mouse_x, int mouse_y){
    if(WidgetUtil.isInsideItemStack(x, y, mouse_x, mouse_y)){
      ...
      final List<ITextComponent> text = screen.getTooltipFromItem(itemStack);
      net.minecraftforge.fml.client.gui.GuiUtils.preItemToolTip(itemStack);
      screen.renderWrappedToolTip(matrix, text, mouse_x, mouse_y, font != null ? font : GuiUtil.font);
