...
// ========================================= BUTTON RENDER ===========================================
   ...
   * @param height
   */
  public static final void renderButton(MatrixStack matrix, Widget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height){
    common_button_render_setup(texture); // widget.alpha is not visible
    widget.blit(matrix, widget.x, widget.y, texture_x, texture_y, width, height);
  }
   ...
   */
  public static final void renderButton(MatrixStack matrix, Widget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height, int texture_width, int texture_height){
    common_button_render_setup(texture);
    AbstractGui.blit(matrix, widget.x, widget.y, width, height, texture_x, texture_y, texture_width, texture_height, 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into top and bottom parts. */
  public static final void verticalSplitRender(MatrixStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_height){
    ...
    AbstractGui.blit(matrix, gui_x, gui_y,  width, half_height[0], texture_x, texture_y,  width, half_height[0], 256, 256);
    AbstractGui.blit(matrix, gui_x, gui_y2, width, half_height[1], texture_x, texture_y2, width, half_height[1], 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into top and bottom parts. */
  public static final void verticalSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture){
    verticalSplitRender(matrix, gui.x, gui.y, texture.x, texture.y, gui.width, gui.height, texture.max_height);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into top and bottom parts. */
  public static final void verticalSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture, int scale_width, int scale_height){
    ...
    AbstractGui.blit(matrix, gui.x, gui.y,  gui.width, gui_half_height[0], texture.x, texture.y,  texture.width, texture_half_height[0], scale_width, scale_height);
    AbstractGui.blit(matrix, gui.x, gui_y2, gui.width, gui_half_height[1], texture.x, texture_y2, texture.width, texture_half_height[1], scale_width, scale_height);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into left and right parts. */
  public static final void horizontalSplitRender(MatrixStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width){
    ...
    AbstractGui.blit(matrix, gui_x,  gui_y, half_width[0], height, texture_x,  texture_y, half_width[0], height, 256, 256);
    AbstractGui.blit(matrix, gui_x2, gui_y, half_width[1], height, texture_x2, texture_y, half_width[1], height, 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into left and right parts. */
  public static final void horizontalSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture){
    horizontalSplitRender(matrix, gui.x, gui.y, texture.x, texture.y, gui.width, gui.height, texture.max_width);
  }
  
  /** Used to render a larger texture into a smaller space, by splitting the texture into left and right parts. */
  public static final void horizontalSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture, int scale_width, int scale_height){
    ...
    AbstractGui.blit(matrix, gui.x,  gui.y, gui_half_width[0], gui.height, texture.x,  texture.y, texture_half_width[0], texture.height, scale_width, scale_height);
    AbstractGui.blit(matrix, gui_x2, gui.y, gui_half_width[1], gui.height, texture_x2, texture.y, texture_half_width[1], texture.height, scale_width, scale_height);
  }
  
  public static final void crossSplitRender(MatrixStack matrix, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width, int max_height){
    ...
    final int texture_x2 = texture_x + max_width  - half_width[1];
    final int texture_y2 = texture_y + max_height - half_height[1];
    AbstractGui.blit(matrix, gui_x,  gui_y,  half_width[0], half_height[0], texture_x,  texture_y,  half_width[0], half_height[0], 256, 256);
    AbstractGui.blit(matrix, gui_x2, gui_y,  half_width[1], half_height[0], texture_x2, texture_y,  half_width[1], half_height[0], 256, 256);
    AbstractGui.blit(matrix, gui_x,  gui_y2, half_width[0], half_height[1], texture_x,  texture_y2, half_width[0], half_height[1], 256, 256);
    AbstractGui.blit(matrix, gui_x2, gui_y2, half_width[1], half_height[1], texture_x2, texture_y2, half_width[1], half_height[1], 256, 256);
  }
  
  public static final void crossSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture){
    crossSplitRender(matrix, gui.x, gui.y, texture.x, texture.y, gui.width, gui.height, texture.max_width, texture.max_height);
  }

  public static final void crossSplitRender(MatrixStack matrix, Dimensions gui, Dimensions texture, int scale_width, int scale_height){
    final int[]     gui_half_width  = get_half_lengths(gui.width);
    final int[]     gui_half_height = get_half_lengths(gui.height);
    ...
    final int texture_x2 = texture.x + texture.max_width  - texture_half_width[1];
    final int texture_y2 = texture.y + texture.max_height - texture_half_height[1];
    AbstractGui.blit(matrix, gui.x,  gui.y,  gui_half_width[0], gui_half_height[0], texture.x,  texture.y,  texture_half_width[0], texture_half_height[0], scale_width, scale_height);
    AbstractGui.blit(matrix, gui_x2, gui.y,  gui_half_width[1], gui_half_height[0], texture_x2, texture.y,  texture_half_width[1], texture_half_height[0], scale_width, scale_height);
    AbstractGui.blit(matrix, gui.x,  gui_y2, gui_half_width[0], gui_half_height[1], texture.x,  texture_y2, texture_half_width[0], texture_half_height[1], scale_width, scale_height);
    AbstractGui.blit(matrix, gui_x2, gui_y2, gui_half_width[1], gui_half_height[1], texture_x2, texture_y2, texture_half_width[1], texture_half_height[1], scale_width, scale_height);
  }
