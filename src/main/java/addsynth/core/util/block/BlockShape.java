...
public final class BlockShape {
  ...
  public static final VoxelShape[] create_six_sided_binary_voxel_shapes(final double min_size, final double max_size){
    ...
    final VoxelShape center = VoxelShapes.box(min_size, min_size, min_size, max_size, max_size, max_size);
    final VoxelShape west   = VoxelShapes.box(0, min_size, min_size, max_size, max_size, max_size);
    final VoxelShape down   = VoxelShapes.box(min_size, 0, min_size, max_size, max_size, max_size);
    final VoxelShape north  = VoxelShapes.box(min_size, min_size, 0, max_size, max_size, max_size);
    final VoxelShape east   = VoxelShapes.box(min_size, min_size, min_size, 1, max_size, max_size);
    final VoxelShape up     = VoxelShapes.box(min_size, min_size, min_size, max_size, 1, max_size);
    final VoxelShape south  = VoxelShapes.box(min_size, min_size, min_size, max_size, max_size, 1);
    int i;
    for(i = 0; i < max; i++){
